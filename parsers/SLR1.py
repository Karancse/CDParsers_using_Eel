...
def generateslr1(pr2,inp):
    ...
    s="<div class=\"titlespace\"><h1 id=\"title1\">SLR(1)</h1></div><div id=\"outbox1\"><div id=\"firstfollow\"><div class=\"absline\"></div><div class=\"titles\"><div class=\"ftitle2\"><h4 class=\"ftitle1\">FIRST</h4></div><div class=\"ftitle2\"><h4 class=\"ftitle1\">FOLLOW</h4></div></div><div class=\"lists\"><ul class=\"list\">"
    ...
    s+="<table id=\"table1\"><caption>SLR(1) Table</caption><tr><th id=\"table1h1\"></th>"
    for i in T:
        s+="<th>"+i+"</th>"
    s+="<th id=\"table1h2\">$</th>"
    for i in NT[1:-1]:
    ...
    if(len(sc)+len(rc)>0):
        ...
        print("The Given Grammer is Not an SLR(1) Grammar.")
        s+="<h4>The Given Grammar is Not an SLR(1) Grammar</h4></div>"
        return s
    s+="<div class=\"lists1\"><ul class=\"list1\"><li>No SR-Conflicts Exists</li></ul><ul class=\"list1\"><li>No RR-Conflicts Exists</li></ul></div></div><h4>The Given Grammar is an SLR(1) Grammar</h4></div>"
    if(len(inp)==0):
        s+="</div>"
        return s
    ...
    while(i<len(inp)):
        ...
        if(q[0]!=-1):
            ...
            continue
        if(len(q[1])==1):
            for j in range(0,len(pr1[q[1][0]][1])):
                st.pop()
                st.pop()
                zzz=len(stz)-1
                while(stz[zzz]==1):
                ...
                stz[zzz]=1
                stz[zzz-1]=1
            st.append(pr1[q[1][0]][0])
            st.append( tdf[st[-1]][st[-2]][0])
            sti.append(pr1[q[1][0]][0])
