...
def generatelr1(pr2,inp):
    ...
    s="<div class=\"titlespace\"><h1 id=\"title1\">LR(1)</h1></div><div id=\"outbox1\">"
    ...
    s+="<table id=\"table1\"><caption>LR(1) Table</caption><tr><th id=\"table1h1\"></th>"
    for i in T:
        s+="<th>"+i+"</th>"
    s+="<th id=\"table1h2\">$</th>"
    for i in NT[1:-1]:
    ...
    if(len(sc)+len(rc)>0):
        ...
        print("The Given Grammer is Not an LR(1) Grammar.")
        s+="<h4>The Given Grammar is Not an LR(1) Grammar</h4></div>"
        return s
